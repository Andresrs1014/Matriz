          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                required
                className={cn(
                  "w-full px-4 py-3 rounded-lg bg-navy-800 border text-white text-sm placeholder:text-slate-600",
                  "focus:outline-none focus:border-electric focus:shadow-glow-blue transition-all",
                  "border-navy-600"
                )}
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={cn(
                    "w-full px-4 py-3 pr-11 rounded-lg bg-navy-800 border text-white text-sm placeholder:text-slate-600",
                    "focus:outline-none focus:border-electric focus:shadow-glow-blue transition-all",
                    "border-navy-600"
                  )}
                />
            ...
            <button
              ...
              disabled={loading}
              className={cn(
                "w-full flex items-center justify-center gap-2 py-3 px-6 rounded-lg font-medium text-sm transition-all duration-200",
