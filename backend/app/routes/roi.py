...
def submit_parte1(
    ...
    # ← CORREGIDO: eliminada la validación incorrecta
    # El endpoint /proveer-salario en projects.py ya maneja borrar el ROI anterior
    # Este endpoint solo crea/reemplaza sin restricción adicional
