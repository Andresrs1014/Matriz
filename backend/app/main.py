...
async def websocket_endpoint(websocket: WebSocket):
    ...
    El frontend se conecta aquí para recibir eventos en tiempo real:
    - evaluation_created → actualiza la matriz en vivo
    - project_created_from_list → notifica nuevo proyecto desde Lists
    """
